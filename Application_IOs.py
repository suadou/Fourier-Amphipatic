...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.Tableselect.setGeometry(QtCore.QRect(150, 470, 111, 31))
    ...
    def running(self):
        ...
        if self.Check.isChecked():
           ...
           pyplot.contourf(I[0:len(hydro)+round(window/2),0:round(window/2)])  
           pyplot.ylabel('Amino acid position')
           pyplot.xlabel('Turns per amino acid')
           pyplot.xticks([(window)/3.6, round(window/2)], ["1/3.6","1/2"])
           pyplot.xlabel('Turns per amino acid')
